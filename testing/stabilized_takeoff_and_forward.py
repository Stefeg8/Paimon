...
def simulate_hover_forward_hover_land(master, start_time,
    ...
    stabilize_position_hover_v2(master, start_time, hover_duration)

    # Move forward along X axis
    print("moving forward")
    stabilize_position_hover_v2(master, start_time, forward_duration, target_x=forward_distance)

    # Hover again at new position
    print("hovering at new position")
    stabilize_position_hover_v2(master, start_time, hover_duration, target_x=forward_distance)
...
simulate_hover_forward_hover_land(master, start_time,takeoff_thrust,ramp_duration)
